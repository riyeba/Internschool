    ...
    <div className="d-flex flex-column flex-lg-row p-0 relative">
      ...
      <Card
        ...
        style={{
          ...
          padding: "1rem",
          backgroundImage:
            "url('https://images.unsplash.com/photo-1738762388662-dc8387c816ba?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
        ...
        <Card.Body data-aos="zoom-in" data-aos-duration="2000">
          ...
          <Card.Text>
            <p style={{ color: "white", fontSize: "1rem" }} >
              ...
              shrinking’ - this also is True! The introduction of a global
              network of the internet has turned the whole globe into a village.
              The only thing that is emerging fast in the current era is the
              applications of computers and management skills in society.
            </p>
          </Card.Text>
          <Button
